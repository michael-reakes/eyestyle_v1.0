...
$post_zone_list = new dbo_list('post_zone', '', 'post_zone_id');
$d_zones = $post_zone_list->get_all();

$form = new html_form('form_delivery_zone_edit', 'action_delivery_zone_edit.php?id='.$zone->zone_id);
$form->add(new html_form_text('name', true, $zone->name, '', false, 80));
				...
				<tr>
					...
					<td class="attribute_value">
						<div id="post" style="display:block;">
							<h5>Please select from the following:</h5>
