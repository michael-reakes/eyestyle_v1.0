<?php
/**
 * @copyright 2002 Brian Lozier (http://www.massassi.com/bTemplate/)
 */
...
class html_template {
	 ...
	 * @param boolean $reset_vars
	 * @return html_template
	 */
	function html_template($base_path = NULL, $reset_vars = false) {
	 ...
	 *
	 * @param boolean $scalars
	 * @param boolean $arrays
	 * @param boolean $carrays
	 * @param boolean $ifs
	 */
